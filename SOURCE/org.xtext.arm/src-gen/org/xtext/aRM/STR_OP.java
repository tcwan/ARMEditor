...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>STR OP</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.aRM.STR_OP#getRegister <em>Register</em>}</li>
 *   <li>{@link org.xtext.aRM.STR_OP#getImmediate_label <em>Immediate label</em>}</li>
 *   <li>{@link org.xtext.aRM.STR_OP#getBAREL_SHIFT_REGISTER <em>BAREL SHIFT REGISTER</em>}</li>
 *   <li>{@link org.xtext.aRM.STR_OP#isOp <em>Op</em>}</li>
 * </ul>
 *
 * @see org.xtext.aRM.ARMPackage#getSTR_OP()
 * @model
 * @generated
 */
public interface STR_OP extends ldr_str_irpre_instr, ldr_str_spre_instr, ldr_str_irpsot_instr, ldr_str_rpost_instr
{
  /**
   ...
   * @see org.xtext.aRM.ARMPackage#getSTR_OP_Register()
   ...
   * @see org.xtext.aRM.ARMPackage#getSTR_OP_Immediate_label()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.xtext.aRM.ARMPackage#getSTR_OP_BAREL_SHIFT_REGISTER()
   * @model containment="true"
   * @generated
   */
   ...
   * @see #setOp(boolean)
   * @see org.xtext.aRM.ARMPackage#getSTR_OP_Op()
   * @model
   * @generated
   */
  boolean isOp();
  ...
  /**
   * Sets the value of the '{@link org.xtext.aRM.STR_OP#isOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
