...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>add sub instr</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.aRM.add_sub_instr#getRegister <em>Register</em>}</li>
 *   <li>{@link org.xtext.aRM.add_sub_instr#getOperand2 <em>Operand2</em>}</li>
 *   <li>{@link org.xtext.aRM.add_sub_instr#isOp <em>Op</em>}</li>
 * </ul>
 *
 * @see org.xtext.aRM.ARMPackage#getadd_sub_instr()
 * @model
 * @generated
 */
public interface add_sub_instr extends OperationInstr
{
  /**
   ...
   * @see org.xtext.aRM.ARMPackage#getadd_sub_instr_Register()
   ...
   * @see org.xtext.aRM.ARMPackage#getadd_sub_instr_Operand2()
   * @model containment="true"
   * @generated
   */
   ...
   * @see #setOp(boolean)
   * @see org.xtext.aRM.ARMPackage#getadd_sub_instr_Op()
   * @model
   * @generated
   */
  boolean isOp();
  ...
  /**
   * Sets the value of the '{@link org.xtext.aRM.add_sub_instr#isOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
