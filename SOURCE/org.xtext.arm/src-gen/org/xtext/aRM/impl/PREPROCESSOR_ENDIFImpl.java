...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PREPROCESSOR ENDIF</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.aRM.impl.PREPROCESSOR_ENDIFImpl#isHash <em>Hash</em>}</li>
 *   <li>{@link org.xtext.aRM.impl.PREPROCESSOR_ENDIFImpl#isCode <em>Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PREPROCESSOR_ENDIFImpl extends CcodeImpl implements PREPROCESSOR_ENDIF
{
  /**
   ...
   * @generated
   */
  protected PREPROCESSOR_ENDIFImpl()
  {
    super();
  }
  ...
  {
    return ARMPackage.Literals.PREPROCESSOR_ENDIF;
  }
  ...
  public void setHash(boolean newHash)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ARMPackage.PREPROCESSOR_ENDIF__HASH, oldHash, hash));
  }
  ...
  public void setCode(boolean newCode)
  {
    ...
    code = newCode;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ARMPackage.PREPROCESSOR_ENDIF__CODE, oldCode, code));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ARMPackage.PREPROCESSOR_ENDIF__HASH:
        return isHash();
      case ARMPackage.PREPROCESSOR_ENDIF__CODE:
        return isCode();
    }
