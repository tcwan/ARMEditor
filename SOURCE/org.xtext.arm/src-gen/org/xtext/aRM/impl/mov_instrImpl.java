...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>mov instr</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.aRM.impl.mov_instrImpl#getRegister <em>Register</em>}</li>
 *   <li>{@link org.xtext.aRM.impl.mov_instrImpl#getOperand2 <em>Operand2</em>}</li>
 *   <li>{@link org.xtext.aRM.impl.mov_instrImpl#isOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class mov_instrImpl extends OperationInstrImpl implements mov_instr
{
  /**
  ...
  {
    return ARMPackage.Literals.MOV_INSTR;
  }
  ...
  public EList<REGISTER> getRegister()
  {
    if (register == null)
    {
      register = new EObjectContainmentEList<REGISTER>(REGISTER.class, this, ARMPackage.MOV_INSTR__REGISTER);
    }
    return register;
  }
  ...
  public EList<Operand2> getOperand2()
  {
    if (operand2 == null)
    {
      operand2 = new EObjectContainmentEList<Operand2>(Operand2.class, this, ARMPackage.MOV_INSTR__OPERAND2);
    }
    return operand2;
  }
  ...
  public void setOp(boolean newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ARMPackage.MOV_INSTR__OP, oldOp, op));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ARMPackage.MOV_INSTR__REGISTER:
        return ((InternalEList<?>)getRegister()).basicRemove(otherEnd, msgs);
      case ARMPackage.MOV_INSTR__OPERAND2:
