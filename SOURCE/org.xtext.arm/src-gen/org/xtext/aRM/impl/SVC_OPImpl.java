...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SVC OP</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.aRM.impl.SVC_OPImpl#getImmediate_label <em>Immediate label</em>}</li>
 *   <li>{@link org.xtext.aRM.impl.SVC_OPImpl#isOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SVC_OPImpl extends svc_instrImpl implements SVC_OP
{
  /**
  ...
  {
    return ARMPackage.Literals.SVC_OP;
  }
  ...
  public EList<immediate_label> getImmediate_label()
  {
    ...
    {
      immediate_label = new EObjectContainmentEList<immediate_label>(immediate_label.class, this, ARMPackage.SVC_OP__IMMEDIATE_LABEL);
    }
  ...
  public void setOp(boolean newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ARMPackage.SVC_OP__OP, oldOp, op));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ARMPackage.SVC_OP__IMMEDIATE_LABEL:
