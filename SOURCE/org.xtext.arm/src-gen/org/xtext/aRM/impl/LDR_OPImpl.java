...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>LDR OP</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.aRM.impl.LDR_OPImpl#getRegister <em>Register</em>}</li>
 *   <li>{@link org.xtext.aRM.impl.LDR_OPImpl#getImmediate_label <em>Immediate label</em>}</li>
 *   <li>{@link org.xtext.aRM.impl.LDR_OPImpl#getBAREL_SHIFT_REGISTER <em>BAREL SHIFT REGISTER</em>}</li>
 *   <li>{@link org.xtext.aRM.impl.LDR_OPImpl#isOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LDR_OPImpl extends ldr_str_irpre_instrImpl implements LDR_OP
{
  /**
  ...
  {
    return ARMPackage.Literals.LDR_OP;
  }
  ...
  public EList<REGISTER> getRegister()
  {
    if (register == null)
    {
      register = new EObjectContainmentEList<REGISTER>(REGISTER.class, this, ARMPackage.LDR_OP__REGISTER);
    }
    return register;
  }
  ...
  public EList<immediate_label> getImmediate_label()
  {
    ...
    {
      immediate_label = new EObjectContainmentEList<immediate_label>(immediate_label.class, this, ARMPackage.LDR_OP__IMMEDIATE_LABEL);
    }
  ...
  public EList<BAREL_SHIFT_REGISTER> getBAREL_SHIFT_REGISTER()
  {
    ...
    {
      bareL_SHIFT_REGISTER = new EObjectContainmentEList<BAREL_SHIFT_REGISTER>(BAREL_SHIFT_REGISTER.class, this, ARMPackage.LDR_OP__BAREL_SHIFT_REGISTER);
    }
  ...
  public void setOp(boolean newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ARMPackage.LDR_OP__OP, oldOp, op));
  }
