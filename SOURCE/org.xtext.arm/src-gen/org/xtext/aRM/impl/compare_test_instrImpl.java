...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>compare test instr</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.aRM.impl.compare_test_instrImpl#getRegister <em>Register</em>}</li>
 *   <li>{@link org.xtext.aRM.impl.compare_test_instrImpl#getOperand2 <em>Operand2</em>}</li>
 *   <li>{@link org.xtext.aRM.impl.compare_test_instrImpl#isOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class compare_test_instrImpl extends OperationInstrImpl implements compare_test_instr
{
  /**
   ...
   * @generated
   */
  protected compare_test_instrImpl()
  {
    super();
  }
  ...
  {
    return ARMPackage.Literals.COMPARE_TEST_INSTR;
  }
  ...
  public EList<REGISTER> getRegister()
  {
    if (register == null)
    {
      register = new EObjectContainmentEList<REGISTER>(REGISTER.class, this, ARMPackage.COMPARE_TEST_INSTR__REGISTER);
    }
    return register;
  }
  ...
  public EList<Operand2> getOperand2()
  {
    if (operand2 == null)
    {
      operand2 = new EObjectContainmentEList<Operand2>(Operand2.class, this, ARMPackage.COMPARE_TEST_INSTR__OPERAND2);
    }
    return operand2;
  }
  ...
  public void setOp(boolean newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ARMPackage.COMPARE_TEST_INSTR__OP, oldOp, op));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ARMPackage.COMPARE_TEST_INSTR__REGISTER:
        return ((InternalEList<?>)getRegister()).basicRemove(otherEnd, msgs);
      case ARMPackage.COMPARE_TEST_INSTR__OPERAND2:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ARMPackage.COMPARE_TEST_INSTR__OPERAND2:
        return getOperand2();
      case ARMPackage.COMPARE_TEST_INSTR__OP:
        return isOp();
    }
