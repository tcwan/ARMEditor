...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>swp instr</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.aRM.swp_instr#getRegister <em>Register</em>}</li>
 *   <li>{@link org.xtext.aRM.swp_instr#getImmediate_label <em>Immediate label</em>}</li>
 *   <li>{@link org.xtext.aRM.swp_instr#isOp <em>Op</em>}</li>
 * </ul>
 *
 * @see org.xtext.aRM.ARMPackage#getswp_instr()
 * @model
 * @generated
 */
public interface swp_instr extends OperationInstr
{
  /**
   ...
   * @see org.xtext.aRM.ARMPackage#getswp_instr_Register()
   ...
   * @see org.xtext.aRM.ARMPackage#getswp_instr_Immediate_label()
   * @model containment="true"
   * @generated
   */
   ...
   * @see #setOp(boolean)
   * @see org.xtext.aRM.ARMPackage#getswp_instr_Op()
   * @model
   * @generated
   */
  boolean isOp();
  ...
  /**
   * Sets the value of the '{@link org.xtext.aRM.swp_instr#isOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
